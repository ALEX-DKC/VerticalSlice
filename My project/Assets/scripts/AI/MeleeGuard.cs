...
public class MeleeGuard : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (characterController == null)
        {
            Debug.LogWarning("MeleeGuard: No CharacterController found on " + gameObject.name);
        }

        if (animator == null)
        {
            Debug.LogWarning("MeleeGuard: No Animator found on " + gameObject.name);
        }
    }
    ...
    void AttackPlayer()
    {
        ...
        if (!alreadyAttacked)
        {
            ...
            if (player != null)
            {
                ...
                Debug.Log("MeleeGuard punched player for " + attackDamage + " damage.");
            }
    ...
    public void characterHitDamage(float takeDamage)
    {
        ...
        Debug.Log("MeleeGuard took damage: " + takeDamage);
    ...
    void PlayMeleeAttackSound()
    {
        ...
        {
            Debug.LogWarning("MeleeGuard: SoundManager instance is missing.");
        }
    }
